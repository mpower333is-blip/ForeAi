...
export const HANDICAPS_CARDS: HcpCard[] = [
  ...
  { id:"soweto-country-club", name:"Soweto Country Club", town:"Soweto", province:"Gauteng", par:72, tee:"Yellow", lat:-26.256, lng:27.861,
    pars:  [4,3,5,4,4,4,3,4,4, 5,4,5,4,4,4,4,3,4],
    sis:   [13,17,15,9,5,1,7,11,3, 10,8,18,14,4,16,6,12,2],
    metres:[406,149,504,438,396,431,214,403,423, 497,414,469,320,386,375,408,216,435] },

  { id:"springs-country-club", name:"Springs Country Club", town:"Springs", province:"Gauteng", par:72, tee:"White", lat:-26.254, lng:28.443,
    pars:  [4,3,5,5,4,4,4,3,4, 4,4,3,4,5,3,4,5,4],
    sis:   [5,9,13,11,15,1,7,17,3, 2,16,12,6,10,14,4,18,8],
    metres:[379,167,473,495,331,355,335,161,382, 430,318,184,378,498,134,435,478,389] },

  { id:"state-mines-country-club", name:"State Mines Country Club", town:"Brakpan", province:"Gauteng", par:72, tee:"Yellow", lat:-26.236, lng:28.372,
    pars:  [4,4,5,4,3,4,5,3,4, 5,4,4,3,4,5,3,4,4],
    sis:   [12,14,16,4,8,2,10,18,6, 17,13,5,11,3,15,9,1,7],
    metres:[368,344,502,409,186,447,536,138,407, 477,339,396,167,427,544,185,477,336] },

  { id:"state-mines-par-3", name:"State Mines — Par 3 Course", town:"Brakpan", province:"Gauteng", par:54, tee:"Orange", lat:-26.236, lng:28.372,
    pars:  [3,3,3,3,3,3,3,3,3, 3,3,3,3,3,3,3,3,3],
    sis:   [12,14,16,4,8,2,10,18,6, 17,13,5,11,3,15,9,1,7],
    metres:[105,115,105,125,136,95,70,126,135, 130,65,80,90,145,145,115,104,125] },

  { id:"sun-valley-golf-club", name:"Sun Valley Golf Club", town:"Vereeniging", province:"Gauteng", par:58, tee:"Yellow",
  ...
  { id:"woodhill-country-club", name:"Woodhill Country Club", town:"Pretoria", province:"Gauteng", par:72, tee:"White", lat:-25.831, lng:28.341,
    pars:  [4,3,5,4,5,4,3,4,4, 4,5,3,4,4,4,3,5,4],
    sis:   [7,9,5,1,11,13,15,3,17, 8,18,12,2,6,16,14,10,4],
    metres:[344,186,518,409,498,374,182,422,329, 341,486,154,352,379,309,169,484,390] },
];
